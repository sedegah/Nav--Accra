...
-- Sample Accra locations graph (25 nodes)
graph :: Graph
graph = Map.fromList
  [ ("Kotoka Airport", [("Osu",7.0), ("Achimota",15.0), ("Madina",20.0)])
  , ("Osu", [("Kotoka Airport",7.0), ("Accra Central",4.0), ("Labadi",3.5)])
  , ("Achimota", [("Kotoka Airport",15.0), ("Accra Central",10.0), ("Mallam",5.0)])
  , ("Accra Central", [("Osu",4.0), ("Achimota",10.0), ("Labadi",5.0), ("Circle",6.0)])
  , ("Labadi", [("Osu",3.5), ("Accra Central",5.0), ("Teshie",7.0)])
  , ("Madina", [("Kotoka Airport",20.0), ("Tema",25.0), ("Adenta",8.0)])
  , ("Mallam", [("Achimota",5.0), ("Tudu",12.0)])
  , ("Circle", [("Accra Central",6.0), ("Tudu",3.0), ("Tema",28.0)])
  , ("Tudu", [("Mallam",12.0), ("Circle",3.0), ("Nungua",18.0)])
  , ("Tema", [("Madina",25.0), ("Circle",28.0), ("Nungua",15.0)])
...
dijkstra graph start = go initialDist initialPrev initialQueue
  where
    ...
    relaxNeighbors u [] dist prev = (dist, prev)
